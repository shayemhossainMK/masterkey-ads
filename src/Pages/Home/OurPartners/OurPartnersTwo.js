...
export default class OurPartnersTwo extends Component {
  constructor(props) {
    super(props);
          ...
          <div className="">
            <Slider ref={(c) => (this.slider = c)} {...settings}>
              <div key={1} className="mx-2 md:mx-10 pr-5">
                <div>
                  <div className="shadow-2xl bg-base-100 w-40 px-10 py-5 rounded-lg">
                    <img className="w-16 mx-auto" src={daraz} alt="" />
                    <p className="mt-4 text-center">Daraz</p>
                  </div>
                </div>
              </div>
              <div key={2} className="mx-2 md:mx-10 pr-5">
                <div>
                  <div className="shadow-2xl bg-base-100 w-40 px-10 py-6 rounded-lg">
                    <img className="w-[85px] mx-auto" src={bkash} alt="" />
                    <p className="mt-4  text-center">bKash</p>
                  </div>
                </div>
              </div>
              ...
              <div key={4} className="mx-2 md:mx-10 pr-5 mr-5">
                <div>
                  <div className="shadow-2xl bg-base-100 w-40 px-10 py-8  rounded-lg">
              ...
              <div key={5} className="mx-2 md:mx-10 pr-5 mr-5">
                <div>
                  <div className="shadow-2xl bg-base-100 w-40 px-10 py-5 rounded-lg">
                    ...
                    <p className="mt-5 text-center">Walton</p>
                  </div>
                </div>
              </div>
              <div key={6} className="mx-2 md:mx-10 pr-5 mr-5">
                <div className="shadow-2xl bg-base-100 w-40 px-10 py-7 mb-20  rounded-lg">
                  <img className="w-28 mx-auto" src={samsung} alt="" />
                  <p className="mt-6 text-center">Samsung</p>
                </div>
              </div>
            </Slider>
          </div>
